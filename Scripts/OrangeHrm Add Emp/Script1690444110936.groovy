...
WebUI.setText(findTestObject('Object Repository/OrangeHRM Add Emp/Page_OrangeHRM/input_Username_username'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/OrangeHRM Add Emp/Page_OrangeHRM/input_Password_password'), 'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('Object Repository/OrangeHRM Add Emp/Page_OrangeHRM/button_Login'))
